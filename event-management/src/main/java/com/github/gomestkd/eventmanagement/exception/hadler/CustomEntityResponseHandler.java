package com.github.gomestkd.eventmanagement.exception.hadler;

import com.github.gomestkd.eventmanagement.exception.*;
...
public class CustomEntityResponseHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> handleInvalidPasswordExceptions(Exception ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                new Date(),
                ex.getMessage(),
                request.getDescription(false)
